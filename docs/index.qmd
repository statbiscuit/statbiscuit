...
### Useful links
 ...
 + [Cheat sheet: randomisation explained by cows...](https://biosci738.github.io/cowstats/#/section-2) 
...
<big>For the purposes of this activity, when you come to design your experiment only choose **one** variety of tomato and set only **two** treatments (one of which can be a control). Make sure to explore the greenhouse plots and the different natural conditions. </big>
...
Is there anything that needs to be corrected on your graph? *Hint: check axis label spellings* Can you correct  the code and re-run it? Before moving on, please download the data as we will use this for the next section of the workshop.
